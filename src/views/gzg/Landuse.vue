...
export default {
  data(){
    return{
      ...
      showLegend: true,
      legendItems:[
        {index:1,text:'行政办公设施用地',style:'backgroundColor:#FF00C5'},
        {index:2,text:'商务兼容商业用地',style:'backgroundColor:#E60000'},
        {index:3,text:'行政办公设施用地',style:'backgroundColor:#FF00FF'},
        ...
        {index:7,text:'教育科研设施用地',style:'backgroundColor:#FF7FDF'},
        ...
        {index:12,text:'村经济（商业金融业）用地',style:'backgroundColor:#A59D00'},
        ...
        {index:16,text:'公共服务设施用地',style:'backgroundColor:#FFFF00'},
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "gzg-konggui", "fill", industry);
    },
    mouseEvent(){
      let _this = this;
    ...
    getInfo(e) {
      let _this = this;
        ...
        if(features[0].layer.id == 'gzg-konggui'){
  ...
  destroyed() {
    let _this = this;
    removeLayers(window.MAP, ["gzg-konggui"]);
